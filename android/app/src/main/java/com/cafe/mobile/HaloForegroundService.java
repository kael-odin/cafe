 ...
 *
 * When the Cafe app is connected to a desktop server, this service prevents Android
...
public class HaloForegroundService extends Service {
    ...
    private void createNotificationChannel() {
        ...
        channel.setDescription("Keeps connection to Cafe desktop alive for real-time notifications");
